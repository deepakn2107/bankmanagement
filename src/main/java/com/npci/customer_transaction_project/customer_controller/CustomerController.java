...
public class CustomerController {
	...
	@GetMapping("/getcustomerbyfirstname/{first_name}")
	public ResponseEntity<List<Customers>> getCustomerByFirstName(@PathVariable("first_name") String first_name) {
		List<Customers> customers = null;
...
//	}
	...
	public Customers updateCustomerbyId(@PathVariable(value="id") Integer customer_Id, @RequestBody Customers customer) {
		Customers customers = customerRepository.findById(customer_Id).orElseThrow(() -> new ResourcesNotFoundException("Customer not exist in DB with this Id: "+customer_Id));
